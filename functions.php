...
function twentyfifteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( '4 Columns Widget 1', 'twentyfifteen' ),
		'id'            => 'column-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'twentyfifteen' ),
	...
	register_sidebar( array(
		'name'          => __( '4 Columns Widget 2', 'twentyfifteen' ),
		'id'            => 'column-2',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'twentyfifteen' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s visible-all-devices">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( '4 Columns Widget 3', 'twentyfifteen' ),
		'id'            => 'column-3',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'twentyfifteen' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s visible-all-devices">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( '4 Columns Widget 4', 'twentyfifteen' ),
		'id'            => 'column-4',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'twentyfifteen' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s visible-all-devices">',
		'after_widget'  => '</div>',
